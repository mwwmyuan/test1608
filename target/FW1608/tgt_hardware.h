...
#define TX_PA_GAIN 17
#define MAX_DIG_DAC_REGVAL (25)
...
extern const struct HAL_IOMUX_PIN_FUNCTION_MAP app_line_out_detect_cfg;
extern const struct HAL_IOMUX_PIN_FUNCTION_MAP app_line_in_detect_cfg;
