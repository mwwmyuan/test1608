...
/* reg address */
#ifdef FPGA
#define HAL_CACHE_ICACHE_REG_BASE_ADDR 0x00081000
#else
#define HAL_CACHE_ICACHE_REG_BASE_ADDR 0x00011000
#endif

#define HAL_CACHE_DCACHE_REG_BASE_ADDR 0x20029000
...
static inline uint32_t _cache_get_reg_base(enum HAL_CACHE_ID_T id)
{
    switch (id) {
        ...
        case HAL_CACHE_ID_I_CACHE:
            return HAL_CACHE_ICACHE_REG_BASE_ADDR;
        break;
        case HAL_CACHE_ID_D_CACHE:
            return HAL_CACHE_DCACHE_REG_BASE_ADDR;
        break;
    }
