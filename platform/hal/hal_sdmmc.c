...
//SDMMC
static uint32_t sdmmc_ip_base[HAL_SDMMC_ID_NUM] = {0x40110000, };
//SDIO
//static uint32_t sdmmc_ip_base[HAL_SDMMC_ID_NUM] = {0x40100000, };
                   ...
                   void *bounce_buffer)
{
    ...
    if (data->flags & MMC_DATA_READ) {
        ...
        dma_cfg.ch = hal_gpdma_get_chan(HAL_GPDMA_SDMMC, HAL_DMA_HIGH_PRIO);
...
//        dma_cfg.src_periph = HAL_GPDMA_SDIO; 
        dma_cfg.dst_width = HAL_DMA_WIDTH_WORD;
...
int mmc_send_cmd(struct mmc *mmc, struct mmc_cmd *cmd, struct mmc_data *data)
{
    ...
    HAL_SDMMC_TRACE("[%s] send cmd end...");
