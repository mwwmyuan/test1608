...
extern void btdrv_write_memory(uint8_t wr_type,uint32_t address,uint8_t *value,uint8_t length);
...
const uint32_t ins_patch_config_3[] =
{
    16,
...
const uint32_t ins_patch_config_2[] =
{
    32,
...
const uint32_t ins_patch_config_1[] =
{
    32,
    (uint32_t)&ins_patch0,
    (uint32_t)&ins_patch1,
...
const BTDRV_PATCH_STRUCT data_patch0 =
{
    0,
    BTDRV_PATCH_ACT,
    sizeof(dpatch0_data),
...
const BTDRV_PATCH_STRUCT data_patch0_g =
{
    0,
    BTDRV_PATCH_ACT,
...
const uint32_t data_patch_config_g[] =
{
    1,
...
void btdrv_data_patch_write(BTDRV_PATCH_STRUCT *d_patch_p)
{
    uint32_t remap_addr;
    uint8_t i=0;
