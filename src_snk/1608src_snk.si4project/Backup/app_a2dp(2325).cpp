...
//            app_bt_stream_a2dpvolume_reset();
            ...
            TRACE("app_bt_device.a2dp_state[stream_id_flag.id]:%d",app_bt_device.a2dp_state[stream_id_flag.id]);
			...
			memcpy(app_bt_device.rmt_bdAddr.addr, Stream->stream.conn.remDev->bdAddr.addr, BD_ADDR_SIZE);
			DUMP8("0x%02x ", app_bt_device.rmt_bdAddr.addr, BD_ADDR_SIZE);
