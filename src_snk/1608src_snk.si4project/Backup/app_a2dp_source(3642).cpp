...
static  char a2dp_transmit_buffer[A2DP_TRANS_SIZE];
//static AvdtpCodec sink_config_codec;
uint8_t app_a2dp_source_find_process = 0;
...
int app_a2dp_source_linein_on(bool on)
{
    ...
    if (on){
        ...
        app_audio_mempool_get_buff(&buff_play, BT_A2DP_SOURCE_LINEIN_BUFF_SIZE/2);
        ...
        stream_cfg.data_size = BT_A2DP_SOURCE_LINEIN_BUFF_SIZE/2;
