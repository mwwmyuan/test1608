 ...
 * @file datapathps.c
 *
 * @brief Data Path Profile Server implementation.
 *
...
const struct attm_desc_128 datapathps_att_db[DATAPATHPS_IDX_NB] =
{
    ...
    [DATAPATHPS_IDX_TX_VAL]     =   {datapath_tx_char_val_uuid_128_content, PERM(NTF, ENABLE), PERM(RI, ENABLE) | PERM_VAL(UUID_LEN, PERM_UUID_128), DATAPATHPS_MAX_LEN},
