 ...
 ****************************************************************************************
 *
 * @file app_datapath_server.c
 *
 * @brief Data Path Server Application entry point
 *
...
void app_datapath_server_connected_evt_handler(uint8_t conidx)
{
	...
	/*
	 * Requested connection interval: 200ms
	 * Latency: 0
	 * Supervision Timeout: 5 s
	 */
	conn_param.intv_min = 160;
	conn_param.intv_max = 160;
