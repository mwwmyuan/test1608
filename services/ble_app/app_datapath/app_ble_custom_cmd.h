 ...
 * 	!!! becuase the code is used as the index of the BLE_CUSTOM_CMD_INSTANCE_T.cmdHandler, the order of this code
 *		must be the same as customCommandArray !!!
 *
 */
typedef enum
{
...
extern BLE_CUSTOM_CMD_INSTANCE_T     customCommandArray[];
