...
osThreadDef_t os_thread_def_intersys_rx_thread = { (intersys_rx_thread), (osPriorityHigh), (INTERSYS_STACK_SIZE), (os_thread_def_stack_intersys_rx)};
#endif
...
{
    hal_sleep_set_unsleep_lock(HAL_SLEEP_UNSLEEP_LOCK_INTERSYS);  
...
void intersys_sleep_checker(void)
{
    if(intersts_tx_systime != 0 && ((hal_sys_timer_get()-intersts_tx_systime)>MS_TO_TICKS(15000))){
        hal_sleep_clr_unsleep_lock(HAL_SLEEP_UNSLEEP_LOCK_INTERSYS); 
...
#endif
//#define _INTERSYS_DATA_TRACE_ 1
