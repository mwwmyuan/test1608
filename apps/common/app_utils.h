...
enum APP_SYSFREQ_USER_T {
    APP_SYSFREQ_USER_APP_0 = HAL_SYSFREQ_USER_RESVALID_0,
    APP_SYSFREQ_USER_APP_1 = HAL_SYSFREQ_USER_RESVALID_1,
    APP_SYSFREQ_USER_APP_2 = HAL_SYSFREQ_USER_RESVALID_2,
    APP_SYSFREQ_USER_APP_3 = HAL_SYSFREQ_USER_RESVALID_3,
